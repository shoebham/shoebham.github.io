var __defProp = Object.defineProperty,
  ...
  __spreadValues = (e, t) => {
    for (var u in t || (t = {}))
      __hasOwnProp.call(t, u) && __defNormalProp(e, u, t[u]);
    if (__getOwnPropSymbols)
      for (var u of __getOwnPropSymbols(t))
        __propIsEnum.call(t, u) && __defNormalProp(e, u, t[u]);
    return e;
  },
  __objRest = (e, t) => {
    var u = {};
    for (var n in e)
      __hasOwnProp.call(e, n) && t.indexOf(n) < 0 && (u[n] = e[n]);
    if (null != e && __getOwnPropSymbols)
      for (var n of __getOwnPropSymbols(e))
        t.indexOf(n) < 0 && __propIsEnum.call(e, n) && (u[n] = e[n]);
    return u;
  };
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["exports"], t)
    : t(
        ((e = "undefined" != typeof globalThis ? globalThis : e || self).imml =
          {})
      );
})(this, function (e) {
  "use strict";
  ...
  t.exports = (function () {
          ...
          (t.code = function (e) {
            ...
            if (t) {
              ...
              return {
                ...
                text: this.options.pedantic ? u : I(u, "\n"),
              };
            }
          }),
          (t.fences = function (e) {
            ...
            if (t) {
              ...
              if (u.header.length === u.align.length) {
                ...
                for (r = u.cells.length, n = 0; n < r; n++)
                  u.cells[n] = R(u.cells[n], u.header.length);
                return u;
              }
            }
          }),
    ...
    (M.def = N(M.def)
      ...
      (M.bullet = /(?:[*+-]|\d{1,9}[.)])/),
      (M.item = /^( *)(bull) ?[^\n]*(?:\n(?! *bull ?)[^\n]*)*/),
      (M.item = N(M.item, "gm").replace(/bull/g, M.bullet).getRegex()),
      (M.listItemStart = N(/^( *)(bull) */)
      ...
      (M.pedantic = W({}, M.normal, {
        ...
        heading: /^(#{1,6})(.*)(?:\n+|$)/,
        fences: U,
        paragraph: N(M.normal._paragraph)
          .replace("hr", M.hr)
          .replace("heading", " *#{1,6} *[^\n]")
    ...
    (V.punctuation = N(V.punctuation)
      .replace(/punctuation/g, V._punctuation)
      .getRegex()),
      (V.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
      (V.escapedEmSt = /\\\*|\\_/g),
      (V._comment = N(M._comment).replace("(?:--\x3e|$)", "--\x3e").getRegex()),
      (V.emStrong.lDelim = N(V.emStrong.lDelim)
        .replace(/punct/g, V._punctuation)
        .getRegex()),
      (V.emStrong.rDelimAst = N(V.emStrong.rDelimAst, "g")
        .replace(/punct/g, V._punctuation)
        .getRegex()),
      (V.emStrong.rDelimUnd = N(V.emStrong.rDelimUnd, "g")
        .replace(/punct/g, V._punctuation)
        .getRegex()),
      (V._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
      ...
      (V.link = N(V.link)
        ...
        .getRegex()),
      (V.reflink = N(V.reflink).replace("label", V._label).getRegex()),
      (V.reflinkSearch = N(V.reflinkSearch, "g")
        .replace("reflink", V.reflink)
        .replace("nolink", V.nolink)
        .getRegex()),
      (V.normal = W({}, V)),
      (V.pedantic = W({}, V.normal, {
        strong: {
          start: /^__|\*\*/,
          middle:
      ...
      (V.gfm = W({}, V.normal, {
        escape: N(V.escape).replace("])", "~|])").getRegex(),
        _extended_email:
      ...
      (V.gfm.url = N(V.gfm.url, "i")
        .replace("email", V.gfm._extended_email)
        .getRegex()),
      (V.breaks = W({}, V.gfm, {
        br: N(V.br).replace("{2,}", "*").getRegex(),
        text: N(V.gfm.text)
          .replace("\\b_", "\\b_| {2,}\\n")
          .replace(/\{2,\}/g, "*")
          .getRegex(),
    ...
    function Be(e, t, u) {
      ...
      try {
        ...
        if (
          ...
          return (
            "<p>An error occurred:</p><pre>" + me(a.message + "", !0) + "</pre>"
          );
        throw a;
      }
    }
  ...
  const n = "{{NEWLINE}}",
    r = (e) => {
      ...
      for (let r = 0; r < t.length; r++) {
        const e = t[r],
          i = { value: e.trim(), rawValue: e, indentation: e.search(/\S|$/) };
        if (i.value.startsWith("//")) continue;
        const s = u.length ? u[u.length - 1] : { value: "", indentation: 0 };
        i.value || !u.length
          ? u.push(i)
          : ((s.value = s.value + n), (u[u.length - 1] = s));
      }
      return u;
    },
    i = (e, t = 0, u = 0) => {
      ...
      for (let l = 0; l < e.length; l++) {
        const a = e[l],
          o = l < e.length - 1 ? e[l + 1] : { value: "", indentation: -1 },
          D = " ".repeat(u) + a.value;
        if (a.indentation === t)
          if (o.indentation > t) {
            const c = a.value;
            if (
              ((s = c).startsWith("[") && s.endsWith("]")) ||
              s.startsWith("$")
            ) {
              const t = i(e.slice(l + 1), o.indentation);
              n.push({ [c]: t });
            } else {
              (r = o.indentation - t), n.push(D);
              const s = i(e.slice(l + 1), o.indentation, u + r);
              n.push(...s);
            }
          } else {
        ...
        else if (a.indentation < t) return n;
      }
      var s;
      return n;
    },
    s = (e, t = "") => e.replace(new RegExp(n, "g"), t),
    l = (e) => {
      const t = typeof e;
      return null != e && ("object" === t || "function" === t);
    },
    a = (e) => (l(e) ? Object.keys(e)[0] : e).startsWith("$"),
    o = (e) => {
      let t, u;
      if (l(e)) {
        ...
        const n = e.split(":");
        (t = n[0].slice(1)), (u = s(n.slice(1, n.length).join(":")).trim());
      }
      return [t, u.trim()];
    },
    D = (e, t = null, u = null) => {
      ...
      for (const r of e)
        if (a(r)) {
          ...
          D(Object.values(r)[0], n, u);
        } else if (Array.isArray(r)) D(r, t, u);
    ...
    c = (e, t, u = {}) => {
      var n = u,
        { attributes: r } = n,
        i = __objRest(n, ["attributes"]);
      const s = Object.assign(e.createElement(t), __spreadValues({}, i));
      return (
        r && Object.entries(r).forEach(([e, t]) => s.setAttribute(e, t)), s
      );
    },
    p = new u.Renderer();
  p.link = (e, t, u) =>
  ...
  (e.parse = (e) => {
    ...
    (e.process = D),
    (e.render = (e, t, n) => {
      let r = t.querySelector("#imml .pages");
      const i = Object.entries(e.pages).find(([e, t]) => t.home)[0];
      if (!r) {
        const e = c(t, "div", { id: ["imml"] });
        (r = c(t, "div", { classList: ["pages"] })),
          e.appendChild(r),
          (n || t.body).appendChild(e);
      }
      const s = (t, u) => {
        if (t in e.options) {
          const n = e.options[t];
      ...
      Object.entries(e.pages).forEach(([n, s]) => {
        const { elements: l, path: a, options: o } = s,
          D = c(t, "div", { classList: ["page"], id: n });
        r.appendChild(D);
        const h = c(t, "div", { classList: ["breadcrumbs"] }),
          g = a.split("/").slice(1);
        g.forEach((u, n) => {
          const r = n === g.length - 1,
            s = c(t, r ? "span" : "a", { textContent: e.pages[u].label });
          h.appendChild(s),
            r ||
              ((s.href = `#${u === i ? "" : u}`),
          ...
          l.forEach((e) => {
            switch (e.type) {
              case "portal":
                ...
                break;
              case "text":
                const r = u(((e) => e.replace("\\$", "$"))(e.value), {
                  renderer: p,
                  breaks: !0,
                  headerIds: !1,
                });
                D.insertAdjacentHTML("beforeend", r);
            }
          });
      });
      const l = r.querySelector(`#${i}`);
      r.removeChild(l), r.appendChild(l);
      const a = c(t, "style", {
        textContent:
